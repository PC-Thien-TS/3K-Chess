...
export default function ClassicBoard({
  ...
  return (
    <div data-testid="classic-board" className="relative mx-auto aspect-square w-full max-w-[820px] min-w-0 overflow-hidden rounded-[1.5rem] border border-[#5d4926]/40 bg-[#100d09] p-1.5 shadow-[0_20px_56px_rgba(0,0,0,0.72)] sm:rounded-[2.25rem] sm:p-4 md:p-7 md:shadow-[0_28px_80px_rgba(0,0,0,0.82)]">
